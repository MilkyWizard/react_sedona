  ...
  return (
    <div className="container">
      <section className="intro intro_first-page">
        <img className="intro__banner" src="/img/text-sedona-index.svg" width="460" height="350"
      ...
      <section className="advantages">
            ...
            <div className="advantage__photo">
              <picture>
                ...
                <source media="(max-width: 1279px)"
                        srcSet="/img/main-city-tablet@1x.jpg, /img/main-city-tablet@2x.jpg"/>
                <source media="(min-width: 1280px)"
                        srcSet="/img/main-city-desktop@1x.jpg, /img/main-city-desktop@2x.jpg"/>
          ...
          <ul className="features">
            <li className="features__item">
              ...
              <div className="features__text">
                <h3 className="features__header">Жилье</h3>
            ...
            <li className="features__item">
              ...
              <div className="features__text">
                <h3 className="features__header">Сувениры</h3>
            ...
            <li className="features__item">
              ...
              <div className="features__text">
                <h3 className="features__header">Еда</h3>
        ...
        <div className="advantage">
          <div className="advantage__inner">
            <div className="advantage__text">
              <h2 className="advantage__header">Там есть мост дьявола</h2>
            ...
            <div className="advantage__photo">
              <picture>
                <source media="(max-width: 767px)"
                        srcSet="/img/main-bridge-mobile@1x.jpg, /img/main-bridge-mobile@2x.jpg"/>
                <source media="(max-width: 1279px)"
                        srcSet="/img/main-bridge-tablet@1x.jpg, /img/main-bridge-tablet@2x.jpg"/>
                <source media="(min-width: 1280px)"
                        srcSet="/img/main-bridge-desktop@1x.jpg, /img/main-bridge-desktop@2x.jpg"/>
        ...
        <div className="advantages__card advantages__card_short">
          <div className="advantage__inner">
            <div className="advantage__text">
              <h3 className="advantage__header">Небольшая площадь</h3>
        ...
        <div className="advantages__card advantages__card_short">
          <div className="advantage__inner">
            <div className="advantage__text">
              <h3 className="advantage__header">Красивая дорога</h3>
        ...
        <div className="advantages__card advantages__card_short">
          <div className="advantage__inner">
            <div className="advantage__text">
              <h3 className="advantage__header">Мало туристов</h3>
      ...
      <section className="location">
        <div className="location__find">
          <h2 className="location__header">Заинтересовались?</h2>
