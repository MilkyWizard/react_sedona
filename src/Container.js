    ...
    return (
        <div className="container">
            <section className="intro intro_first-page">
                <img className="intro__banner" src="../public/img/text-sedona-index.svg" width="460" height="350" alt="Welcome to Sedona"/>
            </section>
            ...
            <section className="advantages">
                <div className="advantage">
                    <div className="advantage__inner">
                        ...
                        <div className="advantage__photo">
                            <picture>
                                <source media="(max-width: 767px)" srcSet="../public/img/main-city-mobile@1x.jpg, ../public/img/main-city-mobile@2x.jpg"/>
                                <source media="(max-width: 1279px)" srcSet="../public/img/main-city-tablet@1x.jpg, ../public/img/main-city-tablet@2x.jpg"/>
                                <source media="(min-width: 1280px)" srcSet="../public/img/main-city-desktop@1x.jpg, ../public/img/main-city-desktop@2x.jpg"/>
                                <img src="../public/img/main-city-desktop@1x.jpg" alt="Город" width="800" height="400"/>
                            </picture>
                        </div>
                        <ul className="features">
                            <li className="features__item">
                                <div className="features__icon">
                                    <img src="../public/img/icon-house.svg" alt="Жилье"/>
                                </div>
                            ...
                            <li className="features__item">
                                <div className="features__icon-wrapper">
                                    <img src="../public/img/icon-gift.svg" alt="Сувениры"/>
                                </div>
                                <div className="features__text">
                            ...
                            <li className="features__item">
                                <div className="features__icon-wrapper">
                                    <img src="../public/img/icon-burger.svg" width="76" height="69" alt="Еда"/>
                                </div>
                                <div className="features__text">
                ...
                <div className="advantages__card">
                    <div className="advantage__inner">
                        ...
                        <div className="advantage__photo">
                            <picture>
                                <source media="(max-width: 767px)" srcSet="../public/img/main-bridge-mobile@1x.jpg, ../public/img/main-bridge-mobile@2x.jpg"/>
                                <source media="(max-width: 1279px)" srcSet="../public/img/main-bridge-tablet@1x.jpg, ../public/img/main-bridge-tablet@2x.jpg"/>
                                <source media="(min-width: 1280px)" srcSet="../public/img/main-bridge-desktop@1x.jpg, ../public/img/main-bridge-desktop@2x.jpg"/>
                                <img src="../public/img/main-bridge-desktop@1x.jpg" alt="Мост Дьявола" width="800" height="400"/>
                            </picture>
                        </div>
                    </div>
                </div>
            ...
            <section className="location">
                ...
                <div className="map">
                    ...
                    <iframe className="map__source"
                            ...
                            width="320" height="250" frameBorder="0" allowFullScreen=""
            ...
            <footer className="footer">
                ...
                <div className="footer__copyright">
                    ...
                    <a className="footer__copyright-link" href="https://htmlacademy.ru">
                        <img src="../public/img/logo-htmlacademy.svg" width="26.9" height="34.1" alt="HTML Academy"/>
                    </a>
                </div>
            </footer>
        </div>
